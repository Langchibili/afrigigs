...
export interface ApiCountryCountry extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    cities: Schema.Attribute.JSON & Schema.Attribute.DefaultTo<[]>;
    createdAt: Schema.Attribute.DateTime;
    createdBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
    currency: Schema.Attribute.Relation<'oneToOne', 'api::currency.currency'>;
    gig_local_term_plural: Schema.Attribute.String &
      Schema.Attribute.DefaultTo<'Gigs'>;
    gig_local_term_singular: Schema.Attribute.String &
      Schema.Attribute.DefaultTo<'Gig'>;
...
export interface ApiCurrencyCurrency extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    ...
    > &
      Schema.Attribute.Private;
    minimum_national_bid: Schema.Attribute.Decimal &
      Schema.Attribute.Required &
...
export interface ApiEscrowTransactionEscrowTransaction
  extends Struct.CollectionTypeSchema {
...
export interface ApiJobJob extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    ...
    budget_amount: Schema.Attribute.Decimal & Schema.Attribute.Required;
    budget_currency: Schema.Attribute.Relation<
      'manyToOne',
      'api::currency.currency'
    >;
    completed_at: Schema.Attribute.DateTime;
    completion_confirmation_deadline: Schema.Attribute.DateTime;
    country: Schema.Attribute.Relation<'manyToOne', 'api::country.country'>;
    createdAt: Schema.Attribute.DateTime;
    createdBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
    description: Schema.Attribute.RichText & Schema.Attribute.Required;
    escrow_status: Schema.Attribute.Enumeration<
      ['unfunded', 'funded', 'held', 'released', 'refunded']
    > &
      Schema.Attribute.DefaultTo<'unfunded'>;
    escrow_transactions: Schema.Attribute.Relation<
      'oneToMany',
      'api::escrow-transaction.escrow-transaction'
    >;
    ...
    >;
    publishedAt: Schema.Attribute.DateTime;
    scope: Schema.Attribute.Enumeration<['LOCAL', 'FOR_EVERYONE']> &
      Schema.Attribute.Required &
      Schema.Attribute.DefaultTo<'LOCAL'>;
    skills_required: Schema.Attribute.Relation<
      'manyToMany',
...
export interface ApiProfessionalProfileProfessionalProfile
  ...
  attributes: {
    certifications: Schema.Attribute.Component<'profile.certification', true>;
    createdAt: Schema.Attribute.DateTime;
    createdBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
    education_history: Schema.Attribute.JSON & Schema.Attribute.DefaultTo<[]>;
    experience_summary: Schema.Attribute.Text;
    locale: Schema.Attribute.String & Schema.Attribute.Private;
    localizations: Schema.Attribute.Relation<
      'oneToMany',
    ...
    > &
      Schema.Attribute.Private;
    publishedAt: Schema.Attribute.DateTime;
    resume_file: Schema.Attribute.Media<'files'>;
    updatedAt: Schema.Attribute.DateTime;
    updatedBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
    user: Schema.Attribute.Relation<
...
export interface ApiSkilledProfileSkilledProfile
  extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    ...
    localizations: Schema.Attribute.Relation<
      'oneToMany',
      'api::skilled-profile.skilled-profile'
    > &
      Schema.Attribute.Private;
    national_id_number: Schema.Attribute.String &
      Schema.Attribute.Required &
      Schema.Attribute.Private;
    publishedAt: Schema.Attribute.DateTime;
    skills: Schema.Attribute.Relation<
      ...
      'api::skills-catalog.skills-catalog'
    >;
    skills_category: Schema.Attribute.Enumeration<
      [
        'Manual Trades',
        'Digital Services',
        'Domestic Services',
...
export interface ApiSkillsCatalogSkillsCatalog
  extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    ...
    name: Schema.Attribute.String &
      ...
      Schema.Attribute.Unique;
    publishedAt: Schema.Attribute.DateTime;
    skilled_profiles: Schema.Attribute.Relation<
      'manyToMany',
      'api::skilled-profile.skilled-profile'
    >;
    updatedAt: Schema.Attribute.DateTime;
...
export interface ApiVerificationSubmissionVerificationSubmission
  extends Struct.CollectionTypeSchema {
...
export interface PluginUsersPermissionsUser
  ...
  attributes: {
    ...
    is_verified_human: Schema.Attribute.Boolean &
      Schema.Attribute.DefaultTo<false>;
    locale: Schema.Attribute.String & Schema.Attribute.Private;
    localizations: Schema.Attribute.Relation<
      'oneToMany',
    ...
    > &
      Schema.Attribute.Private;
    native_last_city: Schema.Attribute.String;
    password: Schema.Attribute.Password &
      Schema.Attribute.Private &
      Schema.Attribute.SetMinMaxLength<{
        minLength: 6;
      }>;
    posted_jobs: Schema.Attribute.Relation<'oneToMany', 'api::job.job'>;
    professional_profile: Schema.Attribute.Relation<
      'oneToOne',
      'api::professional-profile.professional-profile'
    >;
    profile_completion_professional: Schema.Attribute.Integer &
      Schema.Attribute.SetMinMax<
        {
          max: 100;
          min: 0;
      ...
      > &
      Schema.Attribute.DefaultTo<0>;
    profile_completion_skilled: Schema.Attribute.Integer &
      Schema.Attribute.SetMinMax<
        {
          max: 100;
          min: 0;
    ...
    role: Schema.Attribute.Relation<
      ...
      'plugin::users-permissions.role'
    >;
    skilled_profile: Schema.Attribute.Relation<
      'oneToOne',
      'api::skilled-profile.skilled-profile'
    >;
    trust_score_yes: Schema.Attribute.Integer &
      Schema.Attribute.SetMinMax<
        {
          min: 0;
        },
    ...
    verification_submissions: Schema.Attribute.Relation<
      'oneToMany',
      'api::verification-submission.verification-submission'
    >;
...
declare module '@strapi/strapi' {
  export namespace Public {
    export interface ContentTypeSchemas {
      ...
      'api::escrow-transaction.escrow-transaction': ApiEscrowTransactionEscrowTransaction;
      'api::job.job': ApiJobJob;
      'api::message.message': ApiMessageMessage;
      'api::professional-profile.professional-profile': ApiProfessionalProfileProfessionalProfile;
      'api::review.review': ApiReviewReview;
      'api::skilled-profile.skilled-profile': ApiSkilledProfileSkilledProfile;
      'api::skills-catalog.skills-catalog': ApiSkillsCatalogSkillsCatalog;
      'api::verification-submission.verification-submission': ApiVerificationSubmissionVerificationSubmission;
